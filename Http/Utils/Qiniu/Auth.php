...
namespace Modules\AntOA\Http\Utils\Qiniu;
...
final class Auth
{
    ...
    public function sign($data)
    {
        ...
        return $this->accessKey . ':' . \Modules\AntOA\Http\Utils\Qiniu\Utils::base64_urlSafeEncode($hmac);
    }

    public function signWithData($data)
    {
        $encodedData = \Modules\AntOA\Http\Utils\Qiniu\Utils::base64_urlSafeEncode($data);
