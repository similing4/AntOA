<?php
namespace Modules\AntOA\Http\Utils\Qiniu\Processing;

use Modules\AntOA\Http\Utils\Qiniu;
...
final class ImageUrlBuilder
{
    ...
    public function waterImg(
        ...
        $waterStr = 'watermark/1/image/' . \Modules\AntOA\Http\Utils\Qiniu\Utils::base64_urlSafeEncode($image) . '/';
    ...
    public function waterText(
        ...
        $waterStr = 'watermark/2/text/'
            . \Modules\AntOA\Http\Utils\Qiniu\Utils::base64_urlSafeEncode($text) . '/font/'
            . \Modules\AntOA\Http\Utils\Qiniu\Utils::base64_urlSafeEncode($font) . '/';
        ...
        if (!is_null($fontColor)
            ...
            $waterStr .= 'fill/' . \Modules\AntOA\Http\Utils\Qiniu\Utils::base64_urlSafeEncode($fontColor) . '/';
        }
