...
use Modules\AntOA\Http\Utils\Qiniu\Processing\Operation;
...
final class PersistentFop
{
    ...
    public function execute($bucket, $key, $fops, $pipeline = null, $notify_url = null, $force = false)
    {
        ...
        \Modules\AntOA\Http\Utils\Qiniu\Utils::setWithoutEmpty($params, 'pipeline', $pipeline);
        \Modules\AntOA\Http\Utils\Qiniu\Utils::setWithoutEmpty($params, 'notifyURL', $notify_url);
        if ($force) {
            $params['force'] = 1;
        }
