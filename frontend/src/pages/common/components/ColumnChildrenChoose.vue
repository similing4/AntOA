<template>
	<div>
		...
		<a-modal v-model="isShow" :title="'请选择' + column.tip">
			...
			<standard-table :columns="columns" v-if="columns.length > 0" :data-source="dataSource" :pagination="pagination"
				:selected-rows.sync="selectedRows" :row-key="columns[0].dataIndex"
