		...
		<div class="content">
			...
			<div class="login">
				<a-form @submit="onSubmit" :form="form">
					...
					<a-form-item>
						<a-input size="large" name="password" :placeholder="'请输入' + password_placeholder" autocomplete="autocomplete" type="password" v-model="password">
					...
					<a-form-item>
						<a-button :loading="logging" class="submitbtn" style="width: 100%;margin-top: 24px" size="large" html-type="submit" type="primary">登录
						</a-button>
					</a-form-item>
				</a-form>
			</div>
