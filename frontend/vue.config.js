...
module.exports = {
	...
	configureWebpack: config => {
		let loginVueFile = path.resolve(__dirname, "../../../AntOALogin.vue");
		let loginImportFile = path.resolve(__dirname, "./src/pages/login/Login.js");
		...
		if(!fs.existsSync(loginVueFile))
			fs.writeFileSync(loginImportFile, "export default import('@/pages/login/Login.vue');");
		else
			fs.writeFileSync(loginImportFile, "export default import('@/../../../../AntOALogin.vue');");
